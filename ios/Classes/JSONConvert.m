...
RCT_ENUM_CONVERTER_WITH_REVERSED(
   ...
   (@{
       ...
       @"ZoomVideoSDKError_Session_Reconncting": @(Errors_Session_Reconnecting),
       @"ZoomVideoSDKError_Session_Disconncting": @(Errors_Session_Disconnecting),
...
RCT_ENUM_CONVERTER_WITH_REVERSED(
   ...
   (@{
        ...
        @"ZoomVideoSDKAudioType_Unknow" : @(ZoomVideoSDKAudioType_Unknown),
    }),
